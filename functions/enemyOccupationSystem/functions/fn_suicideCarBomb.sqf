...
CO_fnc_getEnemyFactions = compile preprocessfilelinenumbers "functions\SaberCommonScripts\fn_getEnemyFactions.sqf";
_car = _this select 0;
...
_enemyside = west;
_enemyFactions = [driver _car] call DJOCommon_fnc_getEnemyFactions;
_wait = 1;
